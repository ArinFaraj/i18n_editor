...
void main() {
  group('KeysNotifier', () {
    test('setValue update existing root value', () {
      final nodes = [
        const JsonString(['address1'], {'file1': 'value1'}),
      ];
      final newValues = setValue(
        nodes,
        ['address1'],
        {'file1': 'value2'},
      );
      expect(newValues, [
        const JsonString(['address1'], {'file1': 'value2'}),
      ]);
    });
    ...
    test('setValue update existing child value', () {
      ...
      expect(newValues, [
        ...
        const JsonObject(
          [
            JsonString(['address2', 'address1'], {'file1': 'value4'}),
          ],
          ['address2'],
        ),
      ]);
    ...
    test('setValue add to root', () {
      ...
      expect(newValues, [
        const JsonString(['address1'], {'file1': 'value1'}),
        const JsonString(['address2'], {'file1': 'value2'}),
      ]);
    });
